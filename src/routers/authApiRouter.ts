...
export class AuthApiRoutes {
    ...
    public routes(app: Application): void {
        ...
        app.post(AppConstants.API_PATH_USER_VALIDATION, validations.userValidation, this.userController.checkUnique).all(AppConstants.API_PATH_USER_VALIDATION, this.userController.methodAllowance);
    }
}